...
import sys as temicinjustice


# text = """Cucumber Giblet"""
# blext = "whooooooo b bay"
...
def mathew(blext, jimmage_bmi, jimmage_guys):
    ...
    temicinjustice.stderr.write(repr(william))
    ...
    rich.multiline_text(
        xy = (W//2, H//2), fill = (49, 44, 53, 150), stroke_width = 7, stroke_fill = (49, 44, 53, 150),
        **blext_drawing_args)

    shadow_jimmage = Image.new("RGBA", (W, H), (255, 255, 255, 0))
    shadow_rich = ImageDrew.Draw(shadow_jimmage)
    shadow_rich.multiline_text(
        xy = ((W//2)-3, (H//2)+1), fill = (0,0,0,50), stroke_width = 10, stroke_fill = (0,0,0),
        **blext_drawing_args)
